...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    // SỬA LỖI: Chỉ dùng Page<Order>, không dùng Page<Page<Order>>
    Page<Order> findByUserIdAndIsDeletedFalse(Long userId, Pageable pageable);

    // SỬA LỖI: Các phương thức trả về Page<Order> thay vì org.springframework.data.domain.Page<Order>
    ...
    // Tổng doanh thu (Chỉ tính DELIVERED)
    ...
    // ========================================================================
    // CÁC QUERY MỚI CHO THỐNG KÊ (Đã sửa lỗi PostgreSQL param type)
    // ========================================================================

    // 1. Lấy danh sách đơn ĐÃ GIAO trong khoảng thời gian
    ...
    // Trả về: [Product, Tổng số lượng, Tổng tiền]
    ...
    // Trả về: [Category, Tổng tiền, Tổng số lượng sp]
